...
export default {
	...
	panelBalance: { type: 'sprite', src: graveyard('08_hud/panels/panel_balance_blank.png'), preload: true },
	panelBet: { type: 'sprite', src: graveyard('08_hud/panels/panel_bet_blank.png'), preload: true },
	panelWin: { type: 'sprite', src: graveyard('08_hud/panels/panel_win_blank.png'), preload: true },
	menuButton: { type: 'sprite', src: graveyard('08_hud/controls/button_menu_normal.png'), preload: true },
	menuButtonPressed: { type: 'sprite', src: graveyard('08_hud/controls/button_menu_pressed.png'), preload: true },
	settingsButton: { type: 'sprite', src: graveyard('08_hud/controls/button_settings_normal.png'), preload: true },
	settingsButtonPressed: { type: 'sprite', src: graveyard('08_hud/controls/button_settings_pressed.png'), preload: true },
	infoButton: { type: 'sprite', src: graveyard('08_hud/controls/button_info_normal.png'), preload: true },
	soundOn: { type: 'sprite', src: graveyard('08_hud/controls/button_sound_on.png'), preload: true },
	soundOff: { type: 'sprite', src: graveyard('08_hud/controls/button_sound_off.png'), preload: true },
	plusButton: { type: 'sprite', src: graveyard('08_hud/controls/button_plus_normal.png'), preload: true },
	minusButton: { type: 'sprite', src: graveyard('08_hud/controls/button_minus_normal.png'), preload: true },
	autoplayButton: { type: 'sprite', src: graveyard('08_hud/controls/button_autoplay_normal.png'), preload: true },
	autoplayActive: { type: 'sprite', src: graveyard('08_hud/controls/button_autoplay_active.png'), preload: true },
	turboButton: { type: 'sprite', src: graveyard('08_hud/controls/button_turbo_normal.png'), preload: true },
	turboActive: { type: 'sprite', src: graveyard('08_hud/controls/button_turbo_active.png'), preload: true },
	buyFeatureIdle: { type: 'sprite', src: graveyard('08_hud/buy_feature/buy_feature_idle.png'), preload: true },
	buyFeatureHover: { type: 'sprite', src: graveyard('08_hud/buy_feature/buy_feature_hover.png'), preload: true },
	closeButton: { type: 'sprite', src: graveyard('08_hud/controls/button_close_normal.png'), preload: true },
	...Object.fromEntries([1, 2, 3, 5, 10, 25, 50, 100].map((tier) => [
		[`multiplierLabel${tier}`, { type: 'sprite' as const, src: graveyard(`07_multiplier/labels/multiplier_label_x${tier}.png`), preload: true }],
	])),
	thermos: {
		type: 'sprite',
